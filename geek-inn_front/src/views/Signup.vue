<template>
  <div>
    <div class="form">
      ...
      <div class="head">
        <p class="enregistrer">ENREGISTREZ-VOUS</p>
...
export default {
  ...
  methods: {
    registerUser: async function () {
      const responseSignUp = await registerUser(
        this.username,
        this.email,
        this.phone_number,
        this.password
      );
      this.response = responseSignUp.data.username;

      console.log(40, "REGISTER USER HERE!");
      console.log(
        50,
        this.username,
        this.email,
